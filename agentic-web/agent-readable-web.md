...
The agent-readable web is the set of web representations and interfaces designed so software agents can reliably discover content and capabilities without reconstructing all semantics from visual pages. It is one layer of the broader [agentic web](agentic-web-definition.md).
