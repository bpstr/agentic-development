...
| [Prompt optimization](infrastructure/optimization/prompt-optimization.md) | Compare instructions or demonstrations against explicit metrics before reusing them. DSPy supplies one implementation; this is not automatically model training. |
...
| [Events](infrastructure/events/event-driven-agents.md) and [schedules](infrastructure/events/scheduled-agents.md) | Signals make work eligible. Local-to-cloud scheduling needs explicit timing, overlap, recovery, authority and completion contracts; a successful trigger does not prove delivery. |
