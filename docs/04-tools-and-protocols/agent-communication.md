...
The last row describes a category, not a universal wire format. UI description systems such as A2UI address what is rendered; a transport/event layer addresses how updates arrive. See [generative UI](../07-interfaces-and-rendering/generative-ui.md) for rendering frameworks.
