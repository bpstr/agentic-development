...
The worker can own the loop or submit work to a [managed agent runtime](../08-hosting-and-delivery/managed-agents.md). In both designs, correlate the application run with the provider's request/session identifiers.
