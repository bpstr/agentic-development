...
Use the [model chapter](../02-models-and-providers/README.md) for current model descriptions and official pricing links. Use [managed runtimes](managed-agents.md) when you want a service to own more than inference. Use [tracing](../operations/tracing.md) to see which layer actually consumes time.
