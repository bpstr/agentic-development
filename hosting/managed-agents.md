...
See [execution and state](../agent-systems/orchestration/execution/agent-loops.md), [framework choices](../05-orchestration/frameworks/README.md), and the [background work recipe](../patterns/background-work.md).
